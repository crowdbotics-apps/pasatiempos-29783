"""pasatiempos_29783 URL Configuration
...
admin.site.site_header = "Pasatiempos"
admin.site.site_title = "Pasatiempos Admin Portal"
admin.site.index_title = "Pasatiempos Admin"

# swagger
api_info = openapi.Info(
    title="Pasatiempos API",
    default_version="v1",
    description="API documentation for Pasatiempos App",
)
